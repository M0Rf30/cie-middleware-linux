...
// FIXME: will be enable when cie_sign_sdk will be able to build
...
int sendMessage(const char* szCommand, const char* szParam) {
    ...
    const char* arg = "-Xms1G -Xmx1G -Djna.library.path=\".:/usr/lib\" -classpath \"/usr/share/cieid/cieid.jar\" it.ipzs.cieid.MainApplication";
