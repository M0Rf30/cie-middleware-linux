...
typedef void (*templateInitLibraryFunc)(class CCardTemplate &Template,
void *templateData);
...
typedef void (*templateLoginFunc)(void *pTemplateData, CK_USER_TYPE userType,
ByteArray &Pin);
typedef void (*templateLogoutFunc)(void *pTemplateData, CK_USER_TYPE userType);
typedef void (*templateReadObjectAttributesFunc)(void *pCardTemplateData,
CP11Object *pObject);
typedef void (*templateSignFunc)(void *pCardTemplateData, CP11PrivateKey *pPrivKey,
ByteArray &baSignBuffer, ByteDynArray &baSignature, CK_MECHANISM_TYPE mechanism,
bool bSilent);
typedef void (*templateSignRecoverFunc)(void *pCardTemplateData,
CP11PrivateKey *pPrivKey, ByteArray &baSignBuffer, ByteDynArray &baSignature,
CK_MECHANISM_TYPE mechanism, bool bSilent);
typedef void (*templateDecryptFunc)(void *pCardTemplateData,
CP11PrivateKey *pPrivKey, ByteArray &baEncryptedData,
ByteDynArray &baData, CK_MECHANISM_TYPE mechanism, bool bSilent);
typedef void (*templateGenerateRandomFunc)(void *pCardTemplateData,
ByteArray &baRandomData);
typedef void (*templateInitPINFunc)(void *pCardTemplateData,
ByteArray &baPin);
typedef void (*templateSetPINFunc)(void *pCardTemplateData, ByteArray &baOldPin,
ByteArray &baNewPin, CK_USER_TYPE User);
typedef CK_ULONG (*templateGetObjectSizeFunc)(void *pCardTemplateData,
CP11Object *pObject);
typedef void (*templateSetKeyPINFunc)(void *pTemplateData, CP11Object *pObject,
ByteArray &Pin);
typedef void (*templateSetAttributeFunc)(void *pTemplateData,
CP11Object *pObject, CK_ATTRIBUTE_PTR pTemplate, CK_ULONG ulCount);
typedef std::shared_ptr<CP11Object>(*templateCreateObjectFunc)(
  void *pTemplateData, CK_ATTRIBUTE_PTR pTemplate, CK_ULONG ulCount);
typedef void (*templateDestroyObjectFunc)(void *pTemplateData,
CP11Object &Object);
typedef std::shared_ptr<CP11Object>(*templateGenerateKeyFunc)(
  void *pCardTemplateData, CK_MECHANISM_PTR pMechanism,
  CK_ATTRIBUTE_PTR pTemplate, CK_ULONG ulCount);
typedef void (*templateGenerateKeyPairFunc)(
  void *pCardTemplateData, CK_MECHANISM_PTR pMechanism,
