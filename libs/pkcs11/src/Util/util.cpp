...
std::string HexByte(uint8_t data, bool uppercase) {
  ...
  if (uppercase) dmp << std::uppercase;
...
unsigned long RemoveISOPad(ByteArray &paddedData) {
  init_func for (unsigned long i = paddedData.size() - 1; i >= 0; i--) {
    if (paddedData[i] != 0) {
...
ByteDynArray ISOPad16(const ByteArray &data) {
  init_func ByteDynArray resp(ISOPadLen16(data.size()));
  resp.copy(data);
...
ByteDynArray ISOPad(const ByteArray &data) {
  init_func ByteDynArray resp(ISOPadLen(data.size()));
  resp.copy(data);
  ISOPad(resp, data.size());
...
const char *CardErr(DWORD dwSW) {
  ...
  switch (dwSW) {
    case ERR_CARD_FILE_DEACTIVATED:
      msg = "File is deactivated";
      break;
    case ERR_CARD_FILE_TERMINATED:
      msg = "File is terminated";
      break;
    case ERR_CARD_AUTENTICATION_FAILED:
      msg = "Authentication failed";
      break;
    case ERR_CARD_EEPROM_ERROR:
      msg = "EEPROM error; command aborted";
      break;
    case ERR_CARD_LC_INVALID:
      msg = "LC invalid";
      break;
    case ERR_CARD_LOGICAL_CHANNEL:
      msg = "Logical channel not supported";
      break;
    case ERR_CARD_SM_MODE:
      msg = "SM mode not supported";
      break;
    case ERR_CARD_CHAINING:
      msg = "Chaining error";
      break;
    case ERR_CARD_FILE_STRUCTURE:
      msg = "Command cannot be used for file structure";
      break;
    case ERR_CARD_ACCESS_RIGHT:
      msg = "Required access right not granted";
      break;
    case ERR_CARD_BSOBJ_BLOCKED:
      msg = "BS object blocked";
      break;
    case ERR_CARD_BSOBJ_FORMAT:
      msg = "BS object has invalid format";
      break;
    case ERR_CARD_NO_RANDOM:
      msg = "Conditions of use not satisfied; no random number available";
      break;
    case ERR_CARD_NO_CURRENT_EF:
      msg = "No current EF selected";
      break;
    case ERR_CARD_NO_SM_KEY:
      msg = "Key object for SM not found";
      break;
    case ERR_CARD_SMKEY_FORMAT:
      msg = "Key object used for SM has invalid format";
      break;
    case ERR_CARD_INVALID_DATA_FIELD:
      msg = "Invalid parameters in data field";
      break;
    case ERR_CARD_FUNCTION_NOT_SUPPORTED:
      msg = "Function / mode not supported";
      break;
    case ERR_CARD_FILE_NOT_FOUND:
      msg = "File not found";
      break;
    case ERR_CARD_RECORD_NOT_FOUND:
      msg = "Record / object not found";
      break;
    case ERR_CARD_NOT_ENOUGH_MEMORY:
      msg = "Not enough memory in file / in file system";
      break;
    case ERR_CARD_TLV_LENGTH:
      msg = "LC does not fit the TLV structure of the data field";
      break;
    case ERR_CARD_P1_P2_INVALID:
      msg = "P1/P2 invalid";
      break;
    case ERR_CARD_LC_P1_P2_INVALID:
      msg = "LC does not fit P1/P2";
      break;
    case ERR_CARD_OBJECT_NOT_FOUND:
      msg = "Object not found (GET DATA)";
      break;
    case ERR_CARD_EF_ALREADY_EXISTS:
      msg = "File already exists";
      break;
    case ERR_CARD_DF_ALREADY_EXISTS:
      msg = "DF name already exists";
      break;
    case ERR_CARD_LE_TOO_SMALL:
      msg = "LE does not fit the data to be sent";
      break;
    case ERR_CARD_INS_INVALID:
      msg = "INS invalid";
      break;
    case ERR_CARD_CLA_INVALID:
      msg = "CLA invalid (Hi nibble)";
      break;
    case ERR_CARD_TECHNICAL_ERROR:
      msg = "Technical error";
      break;
    case ERR_CARD_LCYCLE_DEATH:
      msg = "Card life cycle was set to death";
      break;
    case ERR_CARD_FAIL_CORRUPT:
      msg = "Code file corrupted and terminated";
      break;
    case ERR_CARD_CHECKSUM_ERROR:
      msg = "File is invalid because of checksum error";
      break;
    case ERR_CARD_NOT_ENOUGH_XXRAM:
      msg = "Not enough memory available in XRAM";
      break;
    case ERR_CARD_TRANSACTION_ERROR:
      msg = "Transaction error";
      break;
    case ERR_CARD_GENERAL_PROTECTION_FAULT:
      msg = "General protection fault";
      break;
    case ERR_CARD_INTERNAL_FAULT:
      msg = "Internal failure of PK-API (wrong CCMS format?)";
      break;
    case ERR_CARD_KEY_NOT_FOUND:
      msg = "Key object not found";
      break;
    case ERR_CARD_HARDWARE_ATTACK:
      msg = "Internal hardware attack detected, change to life cycle death";
      break;
    case ERR_CARD_TRANS_BUFFER_TOO_SMALL:
      msg = "Transaction buffer too small";
      break;
    case ERR_CARD_INTERNAL_ERROR:
      msg = "Internal assertion";
      break;
    case CARD_OK:
      msg = "OK";
      break;
    case CARD_OK_SECOND_TRIAL:
      msg = "OK, EEPROM written in second trial";
      break;
    case ERR_CARD_OVERFLOW_UNDERFLOW:
      msg = "Overflow through INCREASE / Underflow through DECREASE";
      break;
    default:
