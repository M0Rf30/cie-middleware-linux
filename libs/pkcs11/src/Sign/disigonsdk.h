...
DISIGON_API long disigon_sign_set_string(DISIGON_CTX ctx, int option,
                                         char* value);
...
DISIGON_API long disigon_sign_getcertificates(DISIGON_CTX ctx,
                                              CERTIFICATES* certs);
...
DISIGON_API long disigon_verify_set_string(DISIGON_CTX ctx, int option,
                                           char* value);

// esegue l'operazione di verifica secondo le opzioni passate
DISIGON_API long disigon_verify_verify(DISIGON_CTX ctx,
