...
CTSTInfo::CTSTInfo(UUCBufferedReader& reader) : CASN1Sequence(reader) {}

CTSTInfo::CTSTInfo(const CASN1Object& tstInfo) : CASN1Sequence(tstInfo) {}
...
CASN1Integer CTSTInfo::getSerialNumber() { return elementAt(3); }
