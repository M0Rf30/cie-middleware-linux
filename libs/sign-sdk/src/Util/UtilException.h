...
public:
        ...
        CStringException(const CBaseException& inner,int line,char
...
public:
        ...
        CWinException (const CBaseException& inner,int line,char *fileName,DWORD
errorCode);
};
...
public:
        ...
        CSCardException (const CBaseException& inner,int line,char
*fileName,WORD errorCode);
