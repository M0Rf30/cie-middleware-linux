...
#ifndef _PDF_SIGNATURE_FIELD_EX_H_
#define _PDF_SIGNATURE_FIELD_EX_H_
...
/** Signature field
 */
class PODOFO_DOC_API PdfSignatureFieldEx :public PdfField
{
protected:
...
public:
     ...
     */
    PdfSignatureFieldEx( PdfPage* pPage, const PdfRect & rRect, PdfDocument* pDoc,  const PdfString & rsText, const char* szSubFilter);

	PdfSignatureFieldEx( PdfPage* pPage, const PdfRect & rRect, PdfDocument* pDoc,  const PdfString & rsText, const char* szSubFilter, const ImageData* imageData);

	virtual ~PdfSignatureFieldEx();
