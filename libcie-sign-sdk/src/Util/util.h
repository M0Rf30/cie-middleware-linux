...
#define ERR_CANT_GET_SESSION \
  "Errore nella determinazione della sessione dall'ID"
...
#define ERR_CANT_ADD_SESSION \
  "Errore nella scrittura della sessione nella mappa globale"
...
#define ERR_GET_OBJECT_HANDLE \
  "Errore nella determinazione dell'handle oggetto di sessione"
#define ERR_GET_NEW_OBJECT "Errore nel nuovo ID di oggetto"
#define ERR_GET_PRIVATE "Impossibile determinare se un oggetto � privato"
#define ERR_CHECK_MECHANISM_PARAM \
  "Errore nella verifica dei parametri del mechanism"
#define ERR_CANT_GET_PUBKEY_EXPONENT \
  "Impossibile leggere l'esponente della chiave pubblica"
#define ERR_CANT_GET_PUBKEY_LENGTH \
  "Impossibile leggere la lunghezza chiave pubblica"
#define ERR_CANT_GET_PUBKEY_MODULUS \
  "Impossibile leggere il modulo della chiave pubblica"
#define ERR_PADDING "Errore nell'applicazione del padding"
#define ERR_CRYPTO_ERROR "Errore in un operazione crittografica"
#define ERR_CANT_GET_PRIVKEY_LENGTH \
  "Impossibile leggere la lunghezza chiave privata"
...
#define ERR_CANT_GET_MECHANISM_LENGTH \
  "Impossibile trovare la lunghezza dei dati del mechanism"
...
#define ERR_CANT_GET_DIGEST_LENGTH \
  "Impossibile estrarre la lunghezza del digest"
...
#define ERR_CANT_ESTABLISH_CONTEXT \
  "Impossibile connettersi al servizio smart card"

// slot.cpp
#define ERR_GET_TEMPLATE "Errore nella determinazione del template carta"
#define ERR_CANT_ADD_SLOT \
  "Errore nella scrittura dello slot nella mappa globale"
#define ERR_CANT_DELETE_SLOTLIST \
  "Errore nella cancellazione della lista degli slot"
#define ERR_CANT_GET_SLOT "Errore nella determinazione dello slot dall'ID"
#define ERR_CANT_INIT_SLOTLIST \
  "Errore nell'inizializzazione della lista degli slot"
...
// cardtemplate.cpp
#define ERR_CANT_INIT_TEMPLATES \
  "Errore nell'inizializzazione della lista dei template"
#define ERR_CANT_ADD_TEMPLATE \
  "Errore nella scrittura del template nell'elenco globale"
#define ERR_PARSE_XML_TEMPLATE \
  "Errore nel parse XML del file dei template carta"
#define ERR_XML_TEMPLATE_STRUCT \
  "Errore nella struttura XML del file dei  del template carta"
#define ERR_CANT_LOAD_TEMPLATE_LIBRARY \
  "Errore nel caricamento della DLL del template"
#define ERR_CANT_LOAD_LIBRARY "Errore nel caricamento della DLL"
#define ERR_GET_LIBRARY_FUNCTION_LIST \
  "Errore nel caricamento della TemplateGetFunctionList"
#define ERR_CALL_LIBRARY_FUNCTION_LIST \
  "Errore nella chiamata a TemplateGetFunctionList"
...
#define ERR_CANT_DELETE_TEMPLATES \
  "Errore nella cancellazione della lista dei template"

// carddata.cpp
#define ERR_CANT_INITIALIZE_CARD_STRUCTURES \
  "Errore nell'inizializzazione delle struttura dati della carta"
...
#define ERR_FIND_GDO_ATTRIBUTE \
  "Impossibile trovare il valore di un attributo di un oggetto GDO"
...
#define ERR_GDO_TO_P11_OBJECT \
  "Impossibile creare l'oggetto P11 dall'oggetto GDO"
...
#define ERR_KEY_NOT_SECAUTH \
  "La chiave non � protetta con secondary authentication"
#define ERR_CHANGE_SECAUTH_PIN \
  "Errore nel cambio del PIN di secondary authentication"
#define ERR_GET_SECAUTH_PIN \
  "Impossibile restutuire il PIN di secondary authentication"
#define ERR_SET_SECAUTH_PIN \
  "Impossibile impostare il PIN di secondary authentication"
...
#define ERR_GET_TEMPLATE_ATTRIBUTE \
  "Errore nella ricerca di u attributo in un template P11"
#define ERR_UNBLOCK_SECAUTH_PIN \
  "Errore nello sblocco di un pin di secondary authentication"
...
#define ERR_NO_FREE_CERTIFICATE \
  "Impossibile trovare un certificato disponibile nel GDO"
...
#define ERR_ASN_CONTENTSIZE \
  "Impossibile trovare la llunghezza del contenuto di un TAG ASN"
#define ERR_ASN_ENCODE "Impossibile codificare una struttura ASN"
#define ERR_ASN_ENCODEDSIZE \
  "Impossibile trovare la llunghezza della codifica di una struttura ASN"
#define ERR_ASN_GETTAG \
  "Impossibile creare un oggetto corrispondente a un tag ASN"
#define ERR_ASN_ISSEQUENCE \
  "Impossibile determinare se un tag ASN e una sequence"
#define ERR_ASN_LENGTH "Lunghezza errata nella struttura ASN"

// cardinterface
#define ERR_WRONG_PADDING_LENGTH \
  "Errore nella lunghezza del buffer per il padding"
...
class scopeExitClass {
  ...
  public:
    ...
    scopeExitClass(scopeExitClass &&se) : o(se.o) {
        se.toDelete = false;
    };
