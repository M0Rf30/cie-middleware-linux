...
public class VerifyTable {
  ...
  private void getDataTable(verifyInfo vInfo) {
    ...
    Icon certIcon =
        new ImageIcon(MainFrame.class.getResource("/it/ipzs/cieid/res/Firma/orange_checkbox.png"));
    if (vInfo.isCertValid == 1) {
      s_cert = "Il certificato è valido";
      certIcon =
          new ImageIcon(MainFrame.class.getResource("/it/ipzs/cieid/res/Firma/green_checkbox.png"));
    }
    ...
    Object[][] combi =
        Stream.concat(Arrays.stream(data), Arrays.stream(data_new)).toArray(Object[][]::new);
