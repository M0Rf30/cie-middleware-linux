 ...
 *
 * <p>2007-09-12 Nathan Blomquist -- Linux (KDE/Gnome) support added.
 *
...
public class FileDrop {
    ...
    private void makeDropTarget(
        ...
        try {
            ...
            log(
                    out,
                    "FileDrop: Drop will not work due to previous error. Do you have another listener"
                            + " attached?");
        } // end catch
    ...
    public static class TransferableObject implements java.awt.datatransfer.Transferable {
         ...
         * creates a custom data flavor with a representation class <var>dataClass</var> and the
         ...
         * will be called. If the requested data flavor is not supported, then the {@link
         * Fetcher#getObject getObject()} method will not be called.
         *
         ...
         * may want to know exactly when your data was received in case you need to remove it from
         * its source (or do anyting else to it). When the {@link #getTransferData
         * getTransferData(...)} method is called on the {@link TransferableObject}, the {@link
         * Fetcher}'s {@link #getObject getObject()} method will be called.
         *
         * @author Robert Harder
         * @copyright 2001
         * @version 1.1
