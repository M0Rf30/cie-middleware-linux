 ...
 *
 * <p>For further details see: <a href=
...
public class AESFast {
    ...
    // // add padding
    // int nPadLen = (getBlockSize() - ((plaintext.length + 1 - nOffset) %
    // getBlockSize()));
    ...
    private byte[] unpad(byte[] plaintext) {
        ...
        // System.out.write(outsPlainText.toByteArray(), 0,
        // outsPlainText.toByteArray().length);
        return outsPlainText.toByteArray();
    }
    ...
    // * @return The ciphertext generated using the session key.
    // */
    // public static byte[] encryptECB(byte[] plaintext, int nOffset, byte[] key,
    // int keylen, int
    // nBlockLen)
    // {
    ...
    //
    // public static byte[] encryptCBC(byte[] plaintext, int nOffset, byte[] key,
    // int keylen,
    ...
    // {
    // String msg = "ciao ciao, sto cercando di farlo funzionare e ora vedremo cosa
    // succede
    ...
    //
    // enc = encryptECB(msg.getBytes(), 0, key.getBytes(), KEY_SIZE_256,
    // BLOCK_SIZE_128);
    // System.out.println(Encoder.bytesToHexString(enc));
    //
