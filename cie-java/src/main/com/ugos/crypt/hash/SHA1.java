...
public final class SHA1 {
  ...
  /**
   * This method accepts a string and returns a SHA-1 secure one-way hash value of that string, as a
   * byte array.
   */
  ...
  /**
   * This method accepts a byte array and returns a SHA-1 secure one-way hash value of it, as a byte
   * array.
   */
  ...
  private void engineReset() {
    ...
    for (int i = 0; i < DATA_LENGTH / 4; i++) data[i] = 0;
